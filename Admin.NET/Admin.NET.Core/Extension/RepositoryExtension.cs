...
{
    /// <summary>
    /// 实体假删除 _rep.FakeDelete(id)
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="repository"></param>
    /// <param name="id"></param>
    /// <returns></returns>
    public static bool FakeDelete<T>(this SqlSugarRepository<T> repository, long? id) where T : EntityBase, new()
    {
        return repository.AsUpdateable()
            .SetColumns(u => new T { IsDelete = true }, true)
            .Where(u => u.Id == id)
            .ExecuteCommandHasChange();
    }

    /// <summary>
    /// 实体假删除 _rep.FakeDelete(ids)
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="repository"></param>
    /// <param name="ids"></param>
    /// <returns></returns>
    public static bool FakeDelete<T>(this SqlSugarRepository<T> repository, List<long?> ids) where T : EntityBase, new()
    {
        return repository.AsUpdateable()
            .SetColumns(u => new T { IsDelete = true }, true)
    ...
    /// <summary>
    /// 实体假删除 _rep.FakeDelete(u => u.Id == id)
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="repository"></param>
    /// <param name="expression"></param>
    /// <returns></returns>
    public static bool FakeDelete<T>(this SqlSugarRepository<T> repository, Expression<Func<T, bool>> expression) where T : EntityBase, new()
    {
        return repository.AsUpdateable()
            .SetColumns(u => new T { IsDelete = true }, true)
            .Where(expression)
    ...
    /// <summary>
    /// 实体假删除 _rep.FakeDeleteAsync(id)
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="repository"></param>
    /// <param name="id"></param>
    /// <returns></returns>
    public static async Task<bool> FakeDeleteAsync<T>(this SqlSugarRepository<T> repository, long? id) where T : EntityBase, new()
    {
    ...
    /// <summary>
    /// 实体假删除 _rep.FakeDeleteAsync(ids)
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="repository"></param>
    /// <param name="ids"></param>
    /// <returns></returns>
    public static async Task<bool> FakeDeleteAsync<T>(this SqlSugarRepository<T> repository, List<long?> ids) where T : EntityBase, new()
    {
        return await repository.AsUpdateable()
            .SetColumns(u => new T { IsDelete = true }, true)
            .Where(u => ids.Contains(u.Id))
    ...
    /// <summary>
    /// 实体假删除 _rep.FakeDeleteAsync(u => u.Id == id)
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="repository"></param>
    /// <param name="expression"></param>
    /// <returns></returns>
    public static async Task<bool> FakeDeleteAsync<T>(this SqlSugarRepository<T> repository, Expression<Func<T, bool>> expression) where T : EntityBase, new()
    {
        return await repository.AsUpdateable()
            .SetColumns(u => new T { IsDelete = true }, true)
            .Where(expression)
    ...
    /// <param name="ignore">是否忽略 默认true</param>
    /// <returns> </returns>
    public static ISugarQueryable<T> IgnoreOrgData<T>(this ISugarQueryable<T> queryable, bool ignore = true)
    {
        return ignore ? queryable.ClearFilter<T>() : queryable;
    }
    ...
    /// <param name="ignore">是否忽略 默认true</param>
    /// <returns> </returns>
    public static ISugarQueryable<T, T2> IgnoreOrgData<T, T2>(this ISugarQueryable<T, T2> queryable, bool ignore = true)
    {
        return ignore ? queryable.ClearFilter<T2>() : queryable;
    }
    ...
    /// <param name="ignore">是否忽略 默认true</param>
    /// <returns> </returns>
    public static ISugarQueryable<T, T2, T3> IgnoreOrgData<T, T2, T3>(this ISugarQueryable<T, T2, T3> queryable, bool ignore = true)
    {
        return ignore ? queryable.ClearFilter<T3>() : queryable;
    }
    ...
    /// <param name="ignore">是否忽略 默认true</param>
    /// <returns> </returns>
    public static ISugarQueryable<T, T2, T3, T4> IgnoreOrgData<T, T2, T3, T4>(this ISugarQueryable<T, T2, T3, T4> queryable, bool ignore = true)
    {
        return ignore ? queryable.ClearFilter<T4>() : queryable;
    }
    ...
    /// <param name="ignore">是否忽略 默认true</param>
    /// <returns> </returns>
    public static ISugarQueryable<T, T2, T3, T4, T5> IgnoreOrgData<T, T2, T3, T4, T5>(this ISugarQueryable<T, T2, T3, T4, T5> queryable, bool ignore = true)
    {
        return ignore ? queryable.ClearFilter<T5>() : queryable;
    }
    ...
    /// <param name="ignore">是否忽略 默认true</param>
    /// <returns> </returns>
    public static ISugarQueryable<T, T2, T3, T4, T5, T6> IgnoreOrgData<T, T2, T3, T4, T5, T6>(this ISugarQueryable<T, T2, T3, T4, T5, T6> queryable, bool ignore = true)
    {
        return ignore ? queryable.ClearFilter<T6>() : queryable;
    }
