...
export const SysCacheApiFp = function(configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysCacheBeginCacheLockKeyMsTimeoutMsExpireThrowOnFailureThrowMessagePost(key: string, msTimeout: number, msExpire: number, throwOnFailure: boolean, throwMessage: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminNETResultIDisposable>>> {
...
export const SysCacheApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysCacheBeginCacheLockKeyMsTimeoutMsExpireThrowOnFailureThrowMessagePost(key: string, msTimeout: number, msExpire: number, throwOnFailure: boolean, throwMessage: string, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminNETResultIDisposable>> {
...
export class SysCacheApi extends BaseAPI {
     ...
     */
    public async apiSysCacheBeginCacheLockKeyMsTimeoutMsExpireThrowOnFailureThrowMessagePost(key: string, msTimeout: number, msExpire: number, throwOnFailure: boolean, throwMessage: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminNETResultIDisposable>> {
