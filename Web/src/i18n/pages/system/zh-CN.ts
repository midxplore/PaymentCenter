export default {
	list: {
		...
		welcome: '欢迎',
		welcomeUse: '欢迎使用',
		welcome1: '这里是收款账号分配系统的控制台，可在「收款管理」下维护收款账号、查看收款订单与异常到账。',
		welcome2: '额度按请求金额预占、按实际到账结转，保证不超发；每次到账都会累积到订单并留下流水。',
		welcome3: '右上角「自定义」按钮可以添加、移除或移动部件。',
		goDoc: '文档教程',
		welcomeDescription: '项目特色以及文档链接',
		aboutproject: '关于项目',
		aboutprojectDescription:'支付中心 · 收款账号分配系统。按「收款类型 + 金额」从收款账号池中匹配额度充足的账号并生成订单；到账由外部系统分次上报，全流程可审计。',
		version: '版本信息',
		...
		scheduleContentRequired: '日程内容不能为空',
		updateRecord: '更新记录',
		realTimeIncome: '实时收入',
		projectProgress: '项目进度',
		currentProgress: '当前进度',
		welcomein: '欢迎使用支付中心 · 收款账号分配系统',
