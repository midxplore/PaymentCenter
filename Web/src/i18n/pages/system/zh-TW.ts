export default {
	list: {
		...
		welcome: '歡迎',
		welcomeUse: '歡迎使用',
		welcome1: '這裡是收款帳號分配系統的控制台，可在「收款管理」下維護收款帳號、查看收款訂單與異常到帳。',
		welcome2: '額度按請求金額預佔、按實際到帳結轉，保證不超發；每次到帳都會累積到訂單並留下流水。',
		welcome3: '右上角「自訂」按鈕可以新增、移除或移動部件。',
		goDoc: '文檔教程',
		welcomeDescription: '項目特色以及文檔鏈接',
		aboutproject: '關於項目',
		aboutprojectDescription:'支付中心 · 收款帳號分配系統。按「收款類型 + 金額」從收款帳號池中匹配額度充足的帳號並產生訂單；到帳由外部系統分次上報，全流程可審計。',
		version: '版本信息',
